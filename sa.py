...
SELECT_INTERFACE, PEER_NAME, PEER_IP, DATA_LIMIT, EXPIRY_TIME, CONFIG_FILE, DNS, FIRST_USAGE, CONFIRM_PEER = range(8, 17)  # [8-16]
...
def main():
    ...
    states={
        ...
        FIRST_USAGE: [MessageHandler(filters.TEXT & ~filters.COMMAND, collect_first_usage)],  # Fixed state
