...
SEARCH_PEER, SELECT_PEER_TO_EDIT, EDIT_OPTION, SET_DATA_LIMIT, SET_DNS, SET_EXPIRY_TIME = range(6)
...
def main():
    ...
    states={
        ...
        SEARCH_PEER: [MessageHandler(filters.TEXT & ~filters.COMMAND, search_peer_by_name)],
