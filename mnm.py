...
async def show_peer_page_traffic(update: Update, context: CallbackContext):
    """Show a paginated list of peers for resetting traffic."""
    ...
    query = update.callback_query
    await query.edit_message_text("Select a peer to reset traffic:", reply_markup=reply_markup)



async def handle_peer_pagination_traffic(update: Update, context: CallbackContext):
    """Handle pagination buttons for resetting traffic."""
    query = update.callback_query
    await query.answer()
