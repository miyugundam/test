...
SELECT_INTERFACE = 0 
CREATE_PEER_INTERFACE, CREATE_PEER_NAME, CREATE_PEER_IP, CREATE_PEER_DATA_LIMIT, CREATE_PEER_EXPIRY, CREATE_PEER_DNS, CREATE_PEER_CONFIRMATION = range(7)
SHOW_BACKUPS, CREATE_BACKUP, DELETE_BACKUP, RESTORE_BACKUP = range(4)
EDIT_PEER_INTERFACE, EDIT_PEER_SELECT, EDIT_PEER_FIELD, EDIT_PEER_UPDATE, EDIT_PEER_CONFIRMATION = range(5)
...
async def create_peer(update: Update, context: CallbackContext):
    """Entry point for creating a peer."""
    query = update.callback_query
    await query.answer()
...
async def edit_peer(update: Update, context: CallbackContext):
    """Entry point for editing a peer."""
    query = update.callback_query
    await query.answer()
