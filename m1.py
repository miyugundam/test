...
async def create_peer(update: Update, context: CallbackContext):
    ...
    # Create buttons for interface selection
...
async def handle_interface_selection_create(update: Update, context: CallbackContext):
    """Handle WireGuard interface selection for Create Peer."""
    query = update.callback_query
    await query.answer()
...
async def handle_interface_selection_edit(update: Update, context: CallbackContext):
    """Handle WireGuard interface selection for Edit Peer."""
    query = update.callback_query
    await query.answer()
...
# Step 2: Handle Interface Selection
async def handle_interface_selection_create(update: Update, context: CallbackContext):
    """Handle WireGuard interface selection for Create Peer."""
    query = update.callback_query
    await query.answer()
...
def main():
    ...
    states={
        SELECT_INTERFACE: [CallbackQueryHandler(handle_interface_selection_create, pattern="create_interface_.*")],
    ...
    states={
        SELECT_INTERFACE: [CallbackQueryHandler(handle_interface_selection_edit, pattern="edit_interface_.*")],
